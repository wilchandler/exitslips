...
r1 = Requirement.find_by(standard: sixth_standard1, section: section3)

sixth_standard2 = Standard.find_by_code("6.RP.2")
r2 = Requirement.find_by(section: section3, standard: sixth_standard2)

sixth_standard3 = Standard.find_by_code("6.NS.3")
r3 = Requirement.find_by(section: section3, standard: sixth_standard3)

sixth_standard4 = Standard.find_by_code("6.NS.4")
r4 = Requirement.find_by(section: section3, standard: sixth_standard4)

sixth_standard5 = Standard.find_by_code("6.NS.5")
r5 = Requirement.find_by(section: section3, standard: sixth_standard5)

sixth_standard6 = Standard.find_by_code("6.NS.8")
r6 = Requirement.find_by(section: section3, standard: sixth_standard6)

sixth_standard7 = Standard.find_by_code("6.EE.1")
r7 = Requirement.find_by(section: section3, standard: sixth_standard7)

sixth_standard8 = Standard.find_by_code("6.EE.5")
r8 = Requirement.find_by(section: section3, standard: sixth_standard8)

sixth_standard9 = Standard.find_by_code("6.EE.6")
r9 = Requirement.find_by(section: section3, standard: sixth_standard9)


sixth_standard10 = Standard.find_by_code("6.G.1")
r10 = Requirement.find_by(section: section3, standard: sixth_standard10)

sixth_quiz1 = Quiz.create!(name: "Ratios and Percents I", instructions: "Do these, children!", section_id: 3, requirement: r1)
sixth_quiz1.save
...
sixth_quiz2 = Quiz.create!(name: "Ratios and Percents II", instructions: "Do these, children!", section_id: 3, requirement: r2)
sixth_quiz3 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r3)
sixth_quiz4 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r4)
sixth_quiz5 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r5)
sixth_quiz6 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r6)
sixth_quiz7 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r7)
sixth_quiz8 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r8)
sixth_quiz9 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r9)
sixth_quiz10 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", section_id: 3, requirement: r10)

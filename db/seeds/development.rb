...
sixth_quiz3 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard3, section_id: 4)
sixth_quiz4 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard4, section_id: 4)
sixth_quiz5 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard5, section_id: 4)
sixth_quiz6 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard6, section_id: 4)
sixth_quiz7 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard7, section_id: 4)
sixth_quiz8 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard8, section_id: 4)
sixth_quiz9 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard9, section_id: 4)
sixth_quiz10 = Quiz.create!(name: Faker::Lorem.word.capitalize, instructions: "Do these, children!", standard: sixth_standard10, section_id: 4)
...
30.times do
  ...
  sitting1 = Sitting.create!(student: s, quiz: sixth_quiz1, possible: 5, correct: rand(5))
  sitting2 = Sitting.create!(student: s, quiz: sixth_quiz2, possible: 2, correct: rand(2))
  sitting3 = Sitting.create!(student: s, quiz: , possible: 1, correct: 1)
